...
import com.NPTUMisStone.gym_app.databinding.UserFragmentNowAppointmentBinding;
...
public class NowAppointmentFragment extends Fragment {
    ...
    private UserFragmentNowAppointmentBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        NowAppointmentViewModel nowAppointmentViewModel =new ViewModelProvider(this).get(NowAppointmentViewModel.class);

        binding=UserFragmentNowAppointmentBinding.inflate(inflater,container,false);
    ...
    class NowAppointmentAdapter extends RecyclerView.Adapter<NowAppointmentAdapter.ViewHolder>
    {
        ...
        public NowAppointmentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.user_now_appointment_item, parent, false);
