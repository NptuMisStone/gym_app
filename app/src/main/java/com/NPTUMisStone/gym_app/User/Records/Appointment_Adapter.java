...
public class Appointment_Adapter extends RecyclerView.Adapter<Appointment_Adapter.ViewHolder> {
    List<Appointment_Data> appointmentDataList;
    Context context;

    public Appointment_Adapter(Context context, List<Appointment_Data> appointmentList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Appointment_Data item = appointmentDataList.get(position);
