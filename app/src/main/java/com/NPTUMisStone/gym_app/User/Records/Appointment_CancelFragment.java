...
import com.NPTUMisStone.gym_app.databinding.UserAppointmentCancelBinding;
...
public class Appointment_CancelFragment extends Fragment {

    private UserAppointmentCancelBinding binding;
    private Connection MyConnection;
    ArrayList<Appointment_Data> appointmentData = new ArrayList<>();
    private ProgressBar progressBar;
    TextView nodata;
    public static Appointment_CancelFragment newInstance() {
        return new Appointment_CancelFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        Appointment_CancelViewModel appointmentCancelViewModel =new ViewModelProvider(this).get(Appointment_CancelViewModel.class);

        binding = UserAppointmentCancelBinding.inflate(inflater,container,false);
