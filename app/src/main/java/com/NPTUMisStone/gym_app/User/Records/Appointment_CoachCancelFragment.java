...
public class Appointment_CoachCancelFragment extends Fragment {
    ...
    TextView nodata;
    public static Appointment_CoachCancelFragment newInstance() {
        return new Appointment_CoachCancelFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        Appointment_CoachCancelViewModel appointmentCoachCancelViewModel =new ViewModelProvider(this).get(Appointment_CoachCancelViewModel.class);
