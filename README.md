...
v0.105：使用者首頁地圖正常運作、檔案整理(侑宸)

v0.106：補充地圖、修正檔案問題(侑宸)
...
v1.111：上線啦 發佈應用程式到Play商店封閉測試(侑宸)

v1.112：教練版面及各功能已完善(classAdd有時間再修)剩餘使用者介面(宇哲)

v1.113：地圖圖釘顯示修正(侑宸)

v1.114：整理內部檔案名稱與資料夾配置、移除地圖模組及舊廣告設置(侑宸)

v1.115：修復整理出現造成的分頁Binding錯誤(侑宸)

v1.116：教練版面調整背景及滿版(宇哲)

v1.117：首頁載入時間調整(侑宸)

v1.118：使用者個人資料改版(宇哲)

v1.119：完全移除mapview模組(侑宸)

v1.120：使用者版面修改完成，首頁預約card待增加(宇哲)

v1.121：使用者收藏修改完成，可看課程及教練(宇哲)

v1.122：使用者版面，先ok(宇哲)

v1.123：更新常見問題介面的固定問題(侑宸)

v1.124：使用者預約記錄導航(宇哲)

v1.125：導航重開失去目標修正、部分版面整理(侑宸)

v1.126：使用者查詢版面修正(宇哲)

v1.127：常見問題的固定列表修復(侑宸)

v1.128：修復地圖查詢設定、修改地圖標籤跳轉頁面(侑宸)

v1.129：修復預約顯示到府地址，導航待修改(宇哲)

v1.130：修復導航(宇哲)

v1.131：AI回答內容及版面修正(侑宸)

v1.132：修正導航圖釘顯示(侑宸)

v1.133：1209(宇哲)&專題展Play商店版本(侑宸)
